...
public class ReentrantLock implements Lock, java.io.Serializable {
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        ...
        final boolean nonfairTryAcquire(int acquires) {
            ...
            /**
             * 让某个线程可以多次调用同一个ReentrantLock，每调用一次给state+1，由于某个线程已经持有了锁，所以这里不会有竞争，
    ...
    static final class NonfairSync extends Sync {
         ...
         * acquire on failure.
         * ReentrantLock的lock()方法，那么线程将会独占锁
         *
         * 非公平锁：体现在新来的线程发现锁已经被占用，然后等待锁，
         * 如果占用锁的线程刚释放锁，state置为0，而排队等待锁的线程还未唤醒时，新来的线程就直接抢占了该锁，那么就“插队”了。
         */
        final void lock() {
